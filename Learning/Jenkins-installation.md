...
Jenkins TroubleShoot Guide for aws
Jenkins may ignore or fail to read this configuration.
...
<jenkins.model.JenkinsLocationConfiguration>
  <adminAddress>Email Address of the user</adminAddress>
  <jenkinsUrl>http://98.83.220.159:8080/</jenkinsUrl>
</jenkins.model.JenkinsLocationConfiguration>
```
